...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `${siteUrl}/amazon-tools/fba-fee-calculator/${market.toLowerCase()}`,
    },
    openGraph: {
      title: `Amazon FBA Fee Calculator (${marketUpper} Marketplace) | Grow Orbit`,
      description: `Calculate your Amazon FBA size tier, fulfillment costs, storage fees, and referral commission fees for the ${marketUpper} marketplace.`,
      url: `${siteUrl}/amazon-tools/fba-fee-calculator/${market.toLowerCase()}`,
      type: "website"
    }
  };
}
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `${siteUrl}/amazon-tools/fba-fee-calculator/${market.toLowerCase()}`
      }
    ]
  };
