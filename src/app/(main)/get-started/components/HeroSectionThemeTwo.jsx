        ...
        <div className="relative flex-1 flex flex-col justify-start px-5 md:px-16 lg:px-20 xl:px-28 2xl:px-36 pt-24 sm:pt-24 pb-16 lg:pt-24 lg:pb-20 z-10">
          ...
          <div
            ...
            style={{
              ...
              maskImage: "radial-gradient(ellipse 95% 85% at 35% 45%, black 40%, transparent 95%)",
              WebkitMaskImage: "radial-gradient(ellipse 95% 85% at 35% 45%, black 40%, transparent 95%)"
            }}
          />
