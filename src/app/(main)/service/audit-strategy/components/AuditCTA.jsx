...
import {
  ...
  Calendar, Users, SearchCode, TrendingDown, Target
} from "lucide-react";
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-3 mb-8 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                  ...
                  <span className="text-white font-bold text-[9px] uppercase tracking-[0.4em]">Audit Capacity: Open</span>
                </div>
                ...
                >
                  Stop Funding<br />
                  <span className="text-orange-500">Competitors.</span><br />
                  <span className="italic font-light block mt-2 tracking-normal text-white lowercase" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Start the Audit.
                  </span>
                </h2>

                <p className="text-zinc-400 font-light mb-10 text-base lg:text-lg leading-relaxed max-w-xl">
                  Every week without an audit is compounding waste. Book a **15-minute Orbit Diagnostic** to pinpoint your $10,000+ spend leak—completely free.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 mb-16">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Guaranteed Insights</span>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-wrap items-center gap-x-10 gap-y-3">
                  {[
                    "TACoS & Waste Audit",
                    "Top-Level Keyword Gap",
                    "High-Level Growth Map"
                  ].map((item, i) => (
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-6 sm:p-8 shadow-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-500">
                  ...
                  <div className="flex justify-between items-start mb-10 relative z-10">
                    <div>
                      ...
                      <h4 className="text-2xl font-black text-white uppercase tracking-tighter" style={{ fontFamily: "'Montserrat', sans-serif" }}>Rapid Audit</h4>
                    </div>
                  ...
                  <div className="space-y-0 relative z-10 before:absolute before:inset-y-3 before:left-[19px] before:w-[2px] before:bg-white/10">
                    {[
                      { icon: <SearchCode size={16} />, title: "1. Waste Identification", desc: "Instantly locate the highest-bleeding campaigns." },
                      { icon: <TrendingDown size={16} />, title: "2. Gap Assessment", desc: "Uncover where competitors are winning indexing." },
                      { icon: <Target size={16} />, title: "3. Efficiency Roadmap", desc: "Specific action steps for the next 7 days.", active: true }
                    ].map((step, i) => (
                  ...
                  <div className="mt-10 bg-black/40 border border-white/10 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between relative z-10 backdrop-blur-md gap-4 sm:gap-0">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                         <p className="text-[11px] font-bold text-white uppercase tracking-widest mb-0.5">Rapid Session</p>
                         <p className="text-[10px] text-zinc-500 font-mono">15 Mins • 1-on-1 Discovery</p>
                       </div>
                    </div>
