...
function CountryPricing() {
  const countries = [
    { code: "us", country: "United States",  office: "USPTO",   fee: "$985",   time: "8–10 months",  popular: true  },
    { code: "ca", country: "Canada",          office: "CIPO",    fee: "$1,125", time: "18–24 months", popular: false },
    { code: "eu", country: "European Union",  office: "EUIPO",   fee: "$1,550", time: "4–6 months",   popular: false },
    { code: "de", country: "Germany",         office: "DPMA",    fee: "$990",   time: "3–4 months",   popular: false },
    { code: "jp", country: "Japan",           office: "JPO",     fee: "$1,350", time: "12–18 months", popular: false },
    { code: "mx", country: "Mexico",          office: "IMPI",    fee: "$945",   time: "6–12 months",  popular: false },
    { code: "gb", country: "United Kingdom",  office: "UKIPO",   fee: "$860",   time: "4 months",     popular: false },
  ];
            ...
            >
              ...
              <div className={`h-full border p-7 transition-all duration-500 ${
                ...
                <div className={`flex items-center justify-between py-3 border-t ${c.popular ? "border-white/5" : "border-zinc-100"} mb-5`}>
                  <span className={`text-[10px] font-mono uppercase tracking-widest ${c.popular ? "text-zinc-600" : "text-zinc-400"}`}>Est. Timeline</span>
