export const sandboxContractSubject = "Amazon Growth Partnership Agreement — Ready for Digital Signature ✍️";
export const sandboxContractHeadline = "Growth Partnership Agreement | Digital Signature Ready";

export const sandboxContractBody = `<!-- HIDE_DEFAULT_CTA -->
...
<!-- Executive Summary Card (Bulletproof Table Structure for GoDaddy / Webmail / Outlook / Gmail) -->
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 13.5px; line-height: 1.8; color: #334155; border-collapse: collapse; margin: 0; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        <tr>
          ...
          <td style="padding-bottom: 12px; vertical-align: top; color: #334155; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color: #0f172a;">Agreement Scope:</strong> Full Amazon Account Management &amp; Brand Launch
          </td>
        </tr>
        <tr>
          <td style="padding-bottom: 12px; vertical-align: top; width: 34px; font-size: 16px; font-family: sans-serif;">
          ...
          <td style="padding-bottom: 12px; vertical-align: top; color: #334155; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color: #0f172a;">Initial Term:</strong> 8 Months or Complete 1st Batch Sell-Through
          </td>
        </tr>
        <tr>
          <td style="padding-bottom: 12px; vertical-align: top; width: 34px; font-size: 16px; font-family: sans-serif;">
          ...
          <td style="padding-bottom: 12px; vertical-align: top; color: #334155; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color: #0f172a;">Total Package Fee:</strong> $8,500 USD (3 Flexible Installments)
          </td>
        </tr>
        <tr>
          <td style="padding-bottom: 12px; vertical-align: top; width: 34px; font-size: 16px; font-family: sans-serif;">
          ...
          <td style="padding-bottom: 12px; vertical-align: top; color: #334155; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color: #0f172a;">Long-Term Scale:</strong> Transitions to 10% Monthly Profit Share post-term
          </td>
        </tr>
        <tr>
          ...
          <td style="vertical-align: top; color: #334155; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color: #0f172a;">Digital Verification:</strong> Pre-signed by Grow Orbit CEO Ali Haider
          </td>
        </tr>
      </table>
    </td>
...
<p style="font-size: 12.5px; line-height: 1.6; color: #64748b; margin-bottom: 24px; text-align: center; font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  Direct Contract Link: <a href="https://www.groworbitofficial.com/contract/89Z89hOcRymXZSMWxgBF" target="_blank" style="color: #f97316; text-decoration: underline; font-weight: 600;">https://www.groworbitofficial.com/contract/89Z89hOcRymXZSMWxgBF</a>
</p>
...
export const sandboxMicrophoneSubject = "Competitor Sample Procurement — Wireless Lavalier Microphone Benchmarking 🎙️";
...
export const SANDBOX_DRAFTS = [
  {
    ...
    headline: sandboxContractHeadline,
    body: sandboxContractBody
  },
  {
    id: "sandbox-microphone-benchmarking",
    subject: sandboxMicrophoneSubject,
    headline: sandboxMicrophoneHeadline,
