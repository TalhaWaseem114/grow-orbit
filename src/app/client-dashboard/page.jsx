    ...
    <div style={{ minHeight: "100vh", background: "#060606", color: "#fff", fontFamily: "'Montserrat', sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      {loading ? (
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 40, textAlign: "center" }}>
          ...
          <a href={`mailto:hello@groworbit.com?subject=Workspace Setup Request: ${user.email}`} style={{ background: "#f97316", color: "#fff", textDecoration: "none", padding: "10px 20px", borderRadius: 10, fontSize: 11, fontWeight: 800, textTransform: "uppercase" }}>
            ✉️ Contact Support
          </a>
        </div>
      ) : (
