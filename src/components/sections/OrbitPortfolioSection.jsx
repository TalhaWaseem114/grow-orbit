        ...
        <div className="relative">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 relative z-10">
            <div className="max-w-xl">
              ...
              >
                Our Work in <span className="text-zinc-500 italic font-normal lowercase tracking-normal text-[32px] sm:text-[38px] md:text-[46px]" style={{ fontFamily: "'Playfair Display', serif" }}>Real-Time.</span>
              </h2>
            </div>
          ...
          <div className="rounded-[24px] sm:rounded-[32px] border border-zinc-100 bg-white overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.03)] mb-8">
            ...
            <div className="px-5 sm:px-8 py-5 sm:py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 w-full sm:w-auto shrink-0">
                ...
                <Link href="/get-started" prefetch={false} className="flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:brightness-110 text-white font-black text-sm uppercase tracking-widest px-7 py-3.5 rounded-2xl no-underline transition-all duration-300 shadow-md">
