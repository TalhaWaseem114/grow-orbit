          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                From Idea To <span className="italic font-normal text-zinc-500 lowercase tracking-normal" style={{ fontFamily: "'Playfair Display', serif" }}>Revenue.</span>
              </h2>
            </div>
        ...
        <div className="bg-white rounded-[24px] sm:rounded-[36px] border border-zinc-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)] overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 sm:px-10 py-3 sm:py-4 border-b border-zinc-50 gap-2">
            <div className="flex items-center gap-1.5 font-mono text-[7px] sm:text-[9px] font-black tracking-[0.2em] sm:tracking-[0.3em] uppercase text-zinc-600 shrink-1 truncate">
              <span className="text-orange-600 text-[10px] sm:text-[13px] leading-none">{">_"}</span>
