...
import {
  TrendingUp, Search, Eye, AlertTriangle,
  ...
  const signals = [
    {
      ...
      headline: "The Growth Plateau: Scaling revenue has become impossible.",
      subline: "Expansion velocity diagnostic.",
      body: "You've hit a wall. No matter how much more you spend on ads, your revenue stays flat. Your current management team is stuck in a 'maintenance' loop, and you lack the technical infrastructure to break into the next tier of Amazon scale. You're working harder for the same results.",
      symptoms: [
        "Month-over-month revenue growth has slowed to <2%",
        "TACoS is increasing faster than total sales volume",
        "Operations are too manual to support a larger catalog",
      ],
    ...
    },
    {
      ...
      headline: "The Profit Drain: You're selling more but keeping less.",
      subline: "Net margin analysis.",
      body: "Amazon fees, high ACoS, and operational waste are eating your margins alive. You're generating massive top-line revenue, but your net profit is shrinking. Without a specialized strategy to recover lost margins, your brand's long-term sustainability is at risk.",
      symptoms: [
        "Net profit margins are declining despite stable sales",
        "Hidden fees and returns are not being audited or managed",
        "Ad spend is focused on low-margin products without a clear plan",
      ],
      featured: true,
    ...
    },
    {
      ...
      label: "MARKET EROSION",
      status: "COMPETITIVE RISK",
      statusColor: "text-emerald-500 bg-emerald-500/10 border-emerald-500/20",
      headline: "The Authority Gap: Competitors are stealing your share.",
      subline: "Category dominance diagnostic.",
      body: "Aggressive new brands are entering your category with superior visual content and data-backed PPC strategies. You're losing rank for your core keywords, and your brand authority is being diluted. If you don't evolve your growth stack, you'll be relegated to page 2.",
      symptoms: [
        "Organic rank for top 10 keywords is steadily declining",
        "Competitors' A+ content and images are significantly more premium",
        "Losing the 'Amazon's Choice' or 'Best Seller' badge to newer brands",
      ],
    ...
    <section ref={sectionRef} className="py-16 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-5 lg:px-12 relative z-10">
        <div className="mb-12 lg:mb-20">
          <SectionLabel>Service Diagnostic</SectionLabel>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 lg:gap-8 mt-4">
            ...
            <p className="text-zinc-500 text-sm lg:text-base font-light leading-relaxed max-w-md lg:text-right">
              Growth failure isn't accidental. It's structural. We identify the friction points and deploy the specialized services needed to force velocity.
            </p>
          </div>
        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-20 items-start">
                      <div className="lg:col-span-5">
                        <div className={`inline-block mb-3 px-2 py-1 rounded text-[7px] font-mono font-bold ${isFeatured ? "bg-white/5 text-zinc-500" : "bg-zinc-100 text-zinc-400"}`}>
                          SERVICE_SCAN: {s.subline.toUpperCase()}
                        </div>
                        <h3
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-[13px] lg:text-sm font-light leading-relaxed max-w-lg">
                  Uncover your growth friction. Our service diagnostic reveals exactly where you're leaking profit and losing market share.
                </p>
              </div>
            </div>
            <a
