...
import {
  CheckCircle2, ArrowRight, Star, Zap, BarChart4, Target,
} from "lucide-react";
  ...
  const tiers = [
    {
      ...
      features: [
        { label: "Full Listing Health Audit", included: true },
        { label: "Keyword Gap Analysis", included: true },
        { label: "Competitor Benchmarking (Top 3)", included: true },
        { label: "Revenue Leak Identification", included: true },
        { label: "Prioritized Action Roadmap", included: true },
        { label: "PPC Performance Review", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Revenue Leak Identification", included: true },
        { label: "Prioritized Action Roadmap", included: true },
        { label: "PPC Performance Review", included: true },
    ...
    },
    {
      ...
      tagline: "Total strategic command",
      icon: <Zap size={22} />,
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-zinc-500 text-lg font-light leading-relaxed">
            Every tier delivers a complete, actionable audit. The only difference is how deep we go
            and how long we stay by your side.
          </p>
        </div>
