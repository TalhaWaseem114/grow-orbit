...
import {
  ...
  Calendar, Cpu, FastForward, Waypoints, Box
} from "lucide-react";
...
export default function GrowthAutomationCTA() {
  return (
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-3 mb-6 md:mb-8 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                  ...
                  <span className="text-white font-bold text-[9px] uppercase tracking-[0.4em]">Automation Audit: Live</span>
                </div>
                ...
                <p className="text-zinc-400 font-light mb-8 md:mb-10 text-base md:text-lg leading-relaxed max-w-xl">
                  Every hour you spend on repetitive Amazon tasks is an hour not spent on growth. Book a **15-minute Automation Diagnostic** to see how we recover your time while scaling your brand.
                </p>
                ...
                <p className="text-[10px] md:text-[11px] italic text-zinc-500 mb-4 flex items-center gap-2">
                  ...
                  "Joined as Growth Automation. Revenue up 38% in 60 days." — Pet Brand
                </p>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 mb-16">
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-3">
                    ...
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Hands-Free Growth</span>
                  </div>
                </div>
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-500 min-h-[440px] flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-start relative z-10">
                    <div>
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className="text-[8px] font-mono text-orange-500/80 uppercase tracking-widest">Growth Engine</span>
                      </div>
                    ...
                    {[
                      {
                        ...
                        title: "1. Logic Mapping",
                        desc: "Checking rule-based gaps in your structure."
                      },
                      {
                        icon: <Box size={16} />,
                        title: "2. Supply Correlation",
                        desc: "Ensuring ads sync with inventory levels."
                      },
                      {
                        icon: <FastForward size={16} />,
                        title: "3. Speed Multiplier",
                        desc: "Activating rapid harvesting rules.",
                        active: true
                      }
                    ].map((step, i) => (
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 relative z-10 backdrop-blur-md">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                         <p className="text-[11px] font-bold text-white uppercase tracking-widest mb-0.5">Automation Review</p>
