...
import {
  CheckCircle2, ArrowRight, Star, Cpu, BarChart3, Zap,
} from "lucide-react";
  ...
  const tiers = [
    {
      ...
      tagline: "Essential systems setup",
      icon: <Cpu size={22} />,
      accent: "from-orange-500 to-amber-400",
      features: [
        { label: "Inventory Alert Automation", included: true },
        { label: "Basic Repricing Rules", included: true },
        { label: "Monthly P&L Dashboard", included: true },
        { label: "Stock-out Prevention Alerts", included: true },
        { label: "Email Notification Workflows", included: true },
        { label: "Dynamic Pricing Engine", included: false },
        { label: "Multi-Channel Integration", included: false },
        { label: "Dedicated Automation Engineer", included: false },
      ],
      cta: "Get Started",
    },
    {
      ...
      features: [
        { label: "Inventory Alert Automation", included: true },
        { label: "Advanced Repricing Engine", included: true },
        { label: "Weekly P&L Dashboard", included: true },
        { label: "Stock-out Prevention Alerts", included: true },
        { label: "Slack / Email Notification Workflows", included: true },
        { label: "Dynamic Pricing Engine", included: true },
        { label: "Multi-Channel Integration", included: true },
        { label: "Dedicated Automation Engineer", included: false },
      ],
      cta: "Book a Call",
    },
    {
      ...
      tagline: "Total operational autopilot",
      icon: <Zap size={22} />,
      accent: "from-violet-500 to-orange-400",
      features: [
        { label: "Inventory Alert Automation", included: true },
        { label: "AI-Driven Repricing Engine", included: true },
        { label: "Real-time P&L Dashboard", included: true },
        { label: "Predictive Stock Forecasting", included: true },
        { label: "Full Notification Ecosystem", included: true },
        { label: "Dynamic Pricing Engine", included: true },
        { label: "Multi-Channel Integration", included: true },
        { label: "Dedicated Automation Engineer", included: true },
      ],
      cta: "Contact Us",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl mb-12 md:mb-20">
          ...
          <p className="text-zinc-500 text-base md:text-lg font-light leading-relaxed">
            From foundational workflow automation to full-stack operational intelligence —
            every tier eliminates manual bottlenecks and scales your efficiency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-5">
          {tiers.map((tier, i) => (
            <div
              key={i}
              className={`group relative rounded-[32px] md:rounded-[40px] overflow-hidden transition-all duration-500 flex flex-col ${
                tier.featured
            ...
            >
              ...
              <div
                className={`flex-1 border border-t-0 rounded-b-[32px] md:rounded-b-[40px] p-6 sm:p-8 lg:p-10 transition-all duration-500 flex flex-col ${
                  tier.featured
              ...
              >
                ...
                <div className="mb-8 mt-4">
                  ...
                  >
                    Custom pricing · Systems efficiency focus
                  </span>
                </div>
        ...
        <p className="text-center text-[11px] text-zinc-400 font-light mt-12">
          Systems automation fees are typically structured as a one-time build fee + monthly maintenance.{" "}
