...
import {
  Cpu, BarChart3, Database, Workflow,
  ...
  const signals = [
    {
      ...
      status: "SCALE CEILING",
      statusColor: "text-red-500 bg-red-500/10 border-red-500/20",
      headline: "The Manual Trap: Your operations can't keep up with your sales.",
      subline: "Process efficiency diagnostic.",
      body: "You're spending 80% of your time on repetitive management tasks instead of high-level strategy. Your team is bogged down in spreadsheets, manual bid adjustments, and inventory tracking. You've hit a growth ceiling that can only be broken by automated infrastructure.",
      symptoms: [
        "Core team spends 20+ hours/week on manual data entry or reporting",
        "Delayed response to competitor price changes or stock-outs",
        "Operational errors are beginning to impact seller performance metrics",
      ],
    ...
    },
    {
      ...
      status: "REPORTING LAG",
      statusColor: "text-orange-500 bg-orange-500/10 border-orange-500/20",
      headline: "The Decision Gap: You're flying blind on yesterday's data.",
      subline: "Real-time analytics analysis.",
      body: "By the time you get your weekly report, the market has already moved. You're making thousand-dollar decisions based on stale data. Without an automated data pipeline, you're always one step behind the algorithm and your automated competitors.",
      symptoms: [
        "No real-time dashboard for cross-account performance tracking",
        "Difficulty calculating true net profit after all Amazon fees and COGS",
        "Inconsistent data mapping between advertising and organic sales",
      ],
      featured: true,
    ...
    },
    {
      ...
      headline: "The Efficiency Leak: Wasting profit on human error.",
      subline: "Algorithmic waste diagnostic.",
      body: "Manual bidding is inherently inefficient. Humans can't process the millions of data points required to optimize bids 24/7. Every hour your campaigns run unoptimized, you're leaking profit to competitors who are using machine learning to out-bid and out-rank you.",
      symptoms: [
        "ACoS variance of >15% due to delayed bid adjustments",
        "High ad spend on non-converting terms during off-peak hours",
        "Lack of rule-based automation for keyword harvesting and negation",
      ],
    ...
    <section ref={sectionRef} className="py-16 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-5 lg:px-12 relative z-10">
        <div className="mb-12 lg:mb-20">
          <SectionLabel>Automation Diagnostic</SectionLabel>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 lg:gap-8 mt-4">
            ...
            <p className="text-zinc-500 text-sm lg:text-base font-light leading-relaxed max-w-md lg:text-right">
              If your operations feel heavy, it's a symptom of system failure. We replace manual friction with automated velocity.
            </p>
          </div>
        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-20 items-start">
                      <div className="lg:col-span-5">
                        <div className={`inline-block mb-3 px-2 py-1 rounded text-[7px] font-mono font-bold ${isFeatured ? "bg-white/5 text-zinc-500" : "bg-zinc-100 text-zinc-400"}`}>
                          AUTO_SCAN: {s.subline.toUpperCase()}
                        </div>
                        <h3
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-[13px] lg:text-sm font-light leading-relaxed max-w-lg">
                  Uncover your operational friction. Our automation diagnostic reveals exactly where you're leaking profit and losing scale.
                </p>
              </div>
            </div>
            <a
