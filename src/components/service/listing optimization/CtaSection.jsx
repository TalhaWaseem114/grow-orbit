...
import {
  ...
  Calendar, Eye, Image as ImageIcon, Search, MousePointer2, Sparkles
} from "lucide-react";
...
export default function ListingAuditCTA() {
  return (
    <div className="w-full pb-10 bg-[#fafafa]">
      <section className="px-6 lg:px-8">
        <div className="max-w-[1400px] mx-auto">
          {/* Main Container with the Spacious py-14 Blueprint */}
          <div className="bg-[#0a0a0a] rounded-[40px] py-10 px-6 sm:px-10 lg:px-16 text-left relative overflow-hidden border border-white/5 group shadow-none">
            ...
            {/* Background Large Icon Decor - Changed to 'Eye' for Listing focus */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none z-0 opacity-[0.05] translate-x-1/4">
              <Eye size={600} strokeWidth={0.2} className="text-orange-500" />
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-3 mb-8 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                  ...
                  <span className="text-white font-bold text-[9px] uppercase tracking-[0.4em]">Listing Analysis: Available</span>
                </div>
                ...
                <p className="text-zinc-400 font-light mb-10 text-base lg:text-lg leading-relaxed max-w-xl">
                  Traffic is expensive—don't waste it on a listing that doesn't sell. Book a **15-minute Listing Diagnostic** to identify the friction points killing your conversion rate.
                </p>
                ...
                <p className="text-[10px] md:text-[11px] italic text-zinc-500 mb-4 flex items-center gap-2">
                  ...
                  "Joined as Listing Opti. Revenue up 38% in 60 days." — Fitness Brand
                </p>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 mb-16">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Instant CRO Wins</span>
                  </div>
                </div>
              ...
              <div className="lg:col-span-5 block mt-12 lg:mt-0 relative group/card">
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-6 sm:p-8 shadow-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-500">
                  ...
                  <div className="flex justify-between items-start mb-10 relative z-10">
                    <div>
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className="text-[8px] font-mono text-orange-500/80 uppercase tracking-widest">Rapid Optimization</span>
                      </div>
                  ...
                  <div className="space-y-0 relative z-10 before:absolute before:inset-y-3 before:left-[19px] before:w-[2px] before:bg-white/10">
                    {[
                      { icon: <ImageIcon size={16} />, title: "1. Visual Audit", desc: "Analyzing Main Image CTR and Gallery conversion flow." },
                      { icon: <Search size={16} />, title: "2. SEO & Backend Check", desc: "Revealing hidden gaps in your indexing and metadata." },
                      { icon: <MousePointer2 size={16} />, title: "3. Copy Polish", desc: "Identifying friction in Bullet Points and Description.", active: true }
                    ].map((step, i) => (
                  ...
                  <div className="mt-8 lg:mt-10 bg-black/40 border border-white/10 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-5 relative z-10 backdrop-blur-md">
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                       ...
                       <div>
                         <p className="text-[11px] font-bold text-white uppercase tracking-widest mb-0.5">1-on-1 Review</p>
                         <p className="text-[10px] text-zinc-500 font-mono">15 Mins • Live Analysis</p>
                       </div>
                    </div>
