...
import {
  ...
  Calendar, Users2, LineChart, Handshake, HeartHandshake
} from "lucide-react";
...
export default function OngoingSupportCTA() {
  return (
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="bg-[#0a0a0a] rounded-[40px] py-14 px-8 lg:px-20 text-left relative overflow-hidden border border-white/5 group shadow-none">
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none z-0 opacity-[0.05] translate-x-1/4">
              <HeartHandshake size={600} strokeWidth={0.2} className="text-orange-500" />
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-3 mb-6 md:mb-8 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                  <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
                  <span className="text-white font-bold text-[8px] sm:text-[9px] uppercase tracking-[0.3em] sm:tracking-[0.4em]">Partnership Status: Accepting Brands</span>
                </div>
                ...
                <p className="text-zinc-400 font-light mb-8 md:mb-10 text-sm md:text-base lg:text-lg leading-relaxed max-w-xl">
                  Most brands plateau because nobody is watching the full picture. We watch everything, every week, so your account never stops improving.
                </p>
                ...
                <p className="text-[10px] md:text-[11px] italic text-zinc-500 mb-4 flex items-center gap-2">
                  ...
                  "Joined as Ongoing Support. Revenue up 38% in 60 days." — Supplement Brand
                </p>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 mb-12 md:mb-16">
                  <AuditCTAButton href="/get-started">
                    Get Free Strategy Call
                  </AuditCTAButton>
                  <div className="flex items-center justify-center sm:justify-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Scale-Ready Support</span>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-white/5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-2.5 text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-white whitespace-nowrap">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-500 min-h-[440px] flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-start relative z-10">
                    <div>
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className="text-[8px] font-mono text-orange-500/80 uppercase tracking-widest">Strategy Call</span>
                      </div>
                  ...
                  <div className="space-y-0 relative z-10 before:absolute before:inset-y-3 before:left-[19.5px] before:w-[1px] before:bg-white/10 py-6">
                    {[
                      {
                        icon: <Users2 size={16} />,
                        title: "1. Integration Fit",
                        desc: "Mapping how our team plugs into your current workflow."
                      },
                      {
                        icon: <LineChart size={16} />,
                        title: "2. Goal Alignment",
                        desc: "Setting 90-day targets for revenue and efficiency."
                      },
                      {
                        icon: <ShieldCheck size={16} />,
                        title: "3. Account Protection",
                        desc: "Outlining our proactive safety and compliance protocols.",
                        active: true
                      }
                    ].map((step, i) => (
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 relative z-10 backdrop-blur-md">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                         <p className="text-[11px] font-bold text-white uppercase tracking-widest mb-0.5">Management Discovery</p>
