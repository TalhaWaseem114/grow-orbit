...
export const PORTFOLIO_ITEMS = [
  /* ─── LISTING IMAGES ─── */
  {
    ...
    outcome: "112% Growth",
    badge: { value: "112%", label: "MoM Growth" },
    ...
    metrics: [
      { label: "MoM Growth", value: "+112%" },
      { label: "Yearly Units", value: "742K" },
      { label: "Daily Sales", value: "$6K+" },
  ...
  /* ─── LISTING IMAGES (NEXA) ─── */
  {
    ...
    brandName: "Nexa",
    outcome: "1.15M Units",
    badge: { value: "1.15M", label: "Yearly Units" },
    ...
    metrics: [
      { label: "MoM Growth", value: "+135%" },
      { label: "Yearly Units", value: "1.15M" },
      { label: "Daily Sales", value: "$9.8K" },
      { label: "Buy Box", value: "99%" },
    ],
    testimonial: {
      quote: "Through technical 3D renders and premium A+ content, we completely transformed their conversion rates, leading to outstanding performance.",
      author: "Marcus C.",
      role: "Founder, Nexa",
    },
  },
  /* ─── LISTING IMAGES & A+ (KAZVO) ─── */
  {
    ...
    brandName: "Kazvo",
    outcome: "812K Units",
    badge: { value: "812K", label: "Yearly Units" },
    ...
    metrics: [
      { label: "MoM Growth", value: "+96%" },
      { label: "Yearly Units", value: "812K" },
      { label: "Daily Sales", value: "$7.6K" },
      { label: "Buy Box", value: "98%" },
    ],
    testimonial: {
  ...
  /* ─── LISTING IMAGES & A+ (GRAFFIXX) ─── */
  {
    ...
    src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560175/grow_orbit_portfolio/assets/portfolio/graffixx/main_images.jpg",
    isDark: false,
    timeline: "10 Days",
    ...
    serviceDetails: {
      ...
      "A+ Content": {
        ...
        images: [
          ...
          { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560158/grow_orbit_portfolio/assets/portfolio/graffixx/Artboard_1_copy_12-1.jpg", label: "Ocean Glass Detail" },
          { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560159/grow_orbit_portfolio/assets/portfolio/graffixx/Artboard_1_copy_12.jpg", label: "Artist Details" },
          ...
          { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560162/grow_orbit_portfolio/assets/portfolio/graffixx/Artboard_1_copy_5.jpg", label: "Comparison" },
        ],
      },
      "Main Image CTR": {
        ...
        images: [
          { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560175/grow_orbit_portfolio/assets/portfolio/graffixx/main_images.jpg", label: "Optimised Hero (After)" }
        ]
      },
    },
    gallery: [
      ...
      { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560174/grow_orbit_portfolio/assets/portfolio/graffixx/lifestyle_cartoon.jpg", label: "Lifestyle Art" },
      { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560172/grow_orbit_portfolio/assets/portfolio/graffixx/collage.jpg", label: "Art Collage" },
      { src: "https://res.cloudinary.com/dciggvulg/image/upload/v1782560176/grow_orbit_portfolio/assets/portfolio/graffixx/new_banner.jpg", label: "Brand Banner" },
    ],
    metrics: [
